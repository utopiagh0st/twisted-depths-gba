...
//
//	Time-stamp: 2026-02-27, 11:22:59
...
#define enemy_bn_gfxTilesLen 128
extern const bn::tile enemy_bn_gfxTiles[4];
...
{
    constexpr inline sprite_item enemy(sprite_shape_size(sprite_shape::SQUARE, sprite_size::NORMAL), 
            sprite_tiles_item(span<const tile>(enemy_bn_gfxTiles, 4), bpp_mode::BPP_4, compression_type::NONE, 1), 
