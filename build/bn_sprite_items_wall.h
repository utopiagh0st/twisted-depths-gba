...
//
//	Time-stamp: 2026-08-13, 19:13:00
...
#define wall_bn_gfxTilesLen 128
extern const bn::tile wall_bn_gfxTiles[4];
...
{
    constexpr inline sprite_item wall(sprite_shape_size(sprite_shape::SQUARE, sprite_size::NORMAL), 
            sprite_tiles_item(span<const tile>(wall_bn_gfxTiles, 4), bpp_mode::BPP_4, compression_type::NONE, 1), 
